...
| Ray Serve | `node1:5000/smartqueue-rayserve:v1` | [serving/docker/Dockerfile.rayserve](https://github.com/yanghao13111/SmartQueue/blob/main/serving/docker/Dockerfile.rayserve) | [serving/docker/docker-compose-rayserve.yaml](https://github.com/yanghao13111/SmartQueue/blob/main/serving/docker/docker-compose-rayserve.yaml) | TBD (Milestone 2) |
| Evaluation (Locust) | `smartqueue-eval` | [serving/docker/Dockerfile.eval](https://github.com/yanghao13111/SmartQueue/blob/main/serving/docker/Dockerfile.eval) | [serving/docker/docker-compose-system.yaml](https://github.com/yanghao13111/SmartQueue/blob/main/serving/docker/docker-compose-system.yaml) | — (benchmarking only) |
...
| Feature Service | `smartqueue-feature-service` | TBD | [data/docker-compose.yml](https://github.com/yanghao13111/SmartQueue/blob/main/data/docker-compose.yml) | TBD (Milestone 2) |
